	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    btn_register.setOnClickListener(new View.OnClickListener() {
	        ...
	        if(et_name.getText().length()<=0){
	            Toast.makeText(profile2.this, "Enter name", Toast.LENGTH_SHORT).show();
	        }
	        else if( et_num1.getText().length()<=0){
	            Toast.makeText(profile2.this, "Enter First Responder Number", Toast.LENGTH_SHORT).show();
	        }
	        else if( et_num2.getText().length()<=0){
	            Toast.makeText(profile2.this, "Enter Second Responder Number", Toast.LENGTH_SHORT).show();
	        }
	        else{
